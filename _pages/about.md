...
My research interests include machine learning and computer vision, with a focus on self-supervised pre-training (SSL) for classification/detection/facial analysis tasks, image generation, editing and face related generation (diffusion).
